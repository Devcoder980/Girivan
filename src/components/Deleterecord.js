...
const deleterecord = () => {
  return (
    <>
        <Navbar/>
        <Searchbar/>
        <div className='flex flex-wrap justify-center gap-20 h-full w-full items-center mt-4'>
            {data.map((a)=>(
    <div className="w-[7cm] h-[10cm] rounded-md">
        ...
        <p  className='font-snans'>{a.content}</p>
         <button type='submit' className='bg-blue-400 rounded-sm mt-2 p-1'>Delete</button>
        </div>
    </div>
